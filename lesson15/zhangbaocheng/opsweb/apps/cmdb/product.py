...
from cmdb.models import Product,Host
...
class ProductAddView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['user_object_list'] = UserProfile.objects.all().order_by('id')
        context['products'] = Product.objects.filter(pid_id=None).order_by('id')
        return context
