...
def create_save_user(sender, **kwargs):
    #print(kwargs) #{'update_fields': None, 'instance': <User: tami>, 'signal': <django.db.models.signals.ModelSignal object at 0x29d8290>, 'created': True, 'raw': False, 'using': 'default'}
