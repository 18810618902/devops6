...
def get_hosts_from_aliyun():
    ...
    :return:
    """
    ecs =  ECSHandler('LTAIHS4WgVnvKAWf', 'qFESXRJzAtQE79uawnCxAYMNcvyU9f', 'cn-shenzhen')
    page = 1
    while True:
...
def get_hosts_from_qcloud():
    ...
    :return:
    """
    ecs = TenHandler('ap-guangzhou', 'AKIDmRuFSU61qUwHQOGkBQSIxRjpjSzKRQBk', 'Vr7GLJBwa8Yr251qXAg6PbgljaJuOl08', "cvm")
