...
if __name__ == '__main__':
    handler = TenHandler('ap-guangzhou', 'AKIDmRuFSU61qUwHQOGkBQSIxRjpjSzKRQBk', 'Vr7GLJBwa8Yr251qXAg6PbgljaJuOl08', "cvm")
    instances, is_success, next_page = handler.get_instances(1)
    #region, secretId, secretKey, module