    ...
    def get_queryset(self):
        ...
        if self.keyword:
            queryset = queryset.filter(Q(name__icontains=self.keyword) |
                                       Q(
                                           authors__name__icontains=self.keyword) |
                                       Q(
                                           publisher__name__icontains=self.keyword))
        return queryset
...
class BookDetailView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['authors'] = Author.objects.all()
        context['publishs'] = Publish.objects.all()
        context['author_list'] = self.get_book_author(**kwargs)
        return context
    ...
    def get_book_author(self, **kwargs):
