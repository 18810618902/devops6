...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'opsweb.context_data.context_data'
...
EMAIL_PORT = 25
EMAIL_HOST_USER = "yktourops@126.com"
EMAIL_HOST_PASSWORD = "yktour123"
EMAIL_USE_TLS = False
EMAIL_FROM = "yktourops@126.com"
...
# Celery_setting
CELERY_BROKER_URL = 'redis://192.168.3.128:6379/0'
...
# CELERY_IMPORTS = ("apps.worker_order.task",)
