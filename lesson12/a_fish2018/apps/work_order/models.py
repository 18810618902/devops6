...
class Statistics(models.Model):
    applicant = models.IntegerField(verbose_name='申请人')
    type0 = models.IntegerField(default=0,verbose_name='数据库')
    type1 = models.IntegerField(default=0,verbose_name='WEB服务器')
    type2 = models.IntegerField(default=0,verbose_name='计划任务')
    type3 = models.IntegerField(default=0,verbose_name='配置文件')
    type4 = models.IntegerField(default=0,verbose_name='其他')
